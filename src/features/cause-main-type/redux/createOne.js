...
export function reducer(state, action) {
  switch (action.type) {
    case CAUSE_MAIN_TYPE_CREATE_ONE_BEGIN:
    ...
    case CAUSE_MAIN_TYPE_CREATE_ONE_SUCCESS:
    ...
    case CAUSE_MAIN_TYPE_CREATE_ONE_FAILURE:
    ...
    case CAUSE_MAIN_TYPE_CREATE_ONE_DISMISS_ERROR:
